...
public class SearchCardResponse {
    public List<CardRepresentation> cards;
    ...
    public static SearchCardResponse from(List<Card> cards, UriInfo uriInfo, String query,
                                        String sort, String direction, int page, int size, 
                                        long totalElements, long totalPages) {
        SearchCardResponse response = new SearchCardResponse();
        
        response.cards = cards.stream()
    ...
    private static Map<String, String> buildLinks(UriInfo uriInfo, String query, String sort, 
        ...
        String baseUrl = baseUri + "cards/search";
